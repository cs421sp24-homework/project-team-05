...
#         self.assertEqual(serializer.data['item_id'], str(self.item.id))
#         self.assertEqual(serializer.data['item_name'], self.item.name)
#         self.assertEqual(serializer.data['description'], self.item.description)
#         self.assertEqual(serializer.data['image'], None)
#         self.assertEqual(str(serializer.data['price']), str(self.transaction.price))

#         self.assertEqual(serializer.data['seller_id'], self.seller.id)
#         self.assertEqual(serializer.data['seller_name'], self.seller.displayname)
#         self.assertEqual(serializer.data['buyer_id'], self.buyer.id)
#         self.assertEqual(serializer.data['buyer_name'], self.buyer.displayname)
